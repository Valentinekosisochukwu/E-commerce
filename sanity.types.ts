...
// Query: *[_type == "category"] | order(name asc) {          _id,      _type,      _createdAt,      _updatedAt,      _rev,      slug,      title,      name}
...
// Query: *[    _type == "sale" &&    isActive == true &&    lower(couponCode) == lower($couponCode)  ] | order(validFrom desc)[0]
