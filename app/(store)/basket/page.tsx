...
function BasketPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (
        ...
        alert(
          "Missing required checkout information. Please ensure you are signed in and your profile is complete."
        );
        setIsLoading(false);
        return;
      }
  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
          ...
          {groupedItems?.map((item) => (
            ...
            >
              ...
              <div
                ...
                onClick={() =>
                  router.push(
                    `/product/${item.product.slug?.current ?? "unknown"}`
                  )
                }
              >
                {/* Product Image */}
      ...
      <div className="w-full lg:w-80 lg:sticky lg:top-4 h-fit bg-white p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg: lg:left-auto">
        <h3 className="tex-xl font-semibold">Order Summary</h3>
